...
/// AgentExecuteRequest : Request body for executing an agent task.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct AgentExecuteRequest {
    /// Additional description appended to each tool's help text shown to the LLM.
    #[serde(rename = "additional_tool_description", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub additional_tool_description: Option<Option<String>>,
    /// Optional AgentProtocol ID to use for this execution.
    #[serde(rename = "agent_protocol_id", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub agent_protocol_id: Option<Option<String>>,
    /// AgentProtocol selection mode.
    #[serde(rename = "agent_protocol_mode", skip_serializing_if = "Option::is_none")]
    pub agent_protocol_mode: Option<models::AgentProtocolMode>,
    /// Display name for the assistant in the conversation.
    #[serde(rename = "assistant_name", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub assistant_name: Option<Option<String>>,
    /// When true, the agent auto-approves tool executions without asking for confirmation.
    #[serde(rename = "auto_approve", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "chatroom_name_generation", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "client_tools", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "max_requests", skip_serializing_if = "Option::is_none")]
    pub max_requests: Option<i32>,
    /// Optional MCP Hub configuration in JSON string form.
    #[serde(rename = "mcp_hub_config_json", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "tool_access", skip_serializing_if = "Option::is_none")]
    pub tool_access: Option<Vec<models::AgentBuiltinToolRequest>>,
    ...
    #[serde(rename = "use_json_tool_calls", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub use_json_tool_calls: Option<Option<bool>>,
    /// Custom system-level instructions appended to the agent's prompt.
    #[serde(rename = "user_custom_instructions", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
