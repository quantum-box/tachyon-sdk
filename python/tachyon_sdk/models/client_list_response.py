...
class ClientListResponse(BaseModel):
    ...
    """ # noqa: E501
    items: List[ClientResponse] = Field(description="Client items")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [ClientResponse.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
