...
class EvaluateActionsResponse(BaseModel):
    ...
    Response body
    """ # noqa: E501
    results: List[ActionEvaluationResult] = Field(description="Evaluation result for each action")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "results": [ActionEvaluationResult.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None
        })
        return _obj
