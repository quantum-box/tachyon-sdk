...
class ServiceAccountListResponse(BaseModel):
    ...
    """ # noqa: E501
    service_accounts: List[ServiceAccountResponse] = Field(alias="serviceAccounts")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "serviceAccounts": [ServiceAccountResponse.from_dict(_item) for _item in obj["serviceAccounts"]] if obj.get("serviceAccounts") is not None else None
        })
        return _obj
