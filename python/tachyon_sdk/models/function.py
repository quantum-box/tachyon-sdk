...
class Function(BaseModel):
    ...
    """ # noqa: E501
    description: StrictStr = Field(description="A description of what the function does")
    name: StrictStr = Field(description="The name of the function")
    parameters: ToolSchema = Field(description="The parameters the function accepts")
    strict: Optional[StrictBool] = Field(default=False, description="Whether to enforce strict parameter validation")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "parameters": ToolSchema.from_dict(obj["parameters"]) if obj.get("parameters") is not None else None,
