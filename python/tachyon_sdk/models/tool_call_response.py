...
class ToolCallResponse(BaseModel):
    ...
    """ # noqa: E501
    function: FunctionCallResponse = Field(description="The function call details")
    id: StrictStr = Field(description="The ID of the tool call")
    type: StrictStr = Field(description="The type of the tool call")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "function": FunctionCallResponse.from_dict(obj["function"]) if obj.get("function") is not None else None,
            "id": obj.get("id"),
            "type": obj.get("type")
        })
        return _obj
