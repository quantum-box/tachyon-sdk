...
class OAuthTokenDetailResponse(BaseModel):
    """
    ...
    provider: StrictStr
    provider_user_id: StrictStr = Field(alias="providerUserId")
    refresh_token: Optional[StrictStr] = Field(default=None, alias="refreshToken")
    __properties: ClassVar[List[str]] = ["accessToken", "expiresAt", "provider", "providerUserId", "refreshToken"]
