...
class ProductVariantListResponse(BaseModel):
    ...
    """ # noqa: E501
    items: List[ProductVariantResponse] = Field(description="Variant items")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [ProductVariantResponse.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
