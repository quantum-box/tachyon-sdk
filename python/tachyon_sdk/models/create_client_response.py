...
class CreateClientResponse(BaseModel):
    ...
    grant_types: List[StrictStr] = Field(alias="grantTypes")
    id: StrictStr
    name: StrictStr
    redirect_uris: List[StrictStr] = Field(alias="redirectUris")
    status: StrictStr
    use_tachyon_user_pool: StrictBool = Field(alias="useTachyonUserPool")
    __properties: ClassVar[List[str]] = ["allowedScopes", "clientId", "clientSecret", "createdAt", "grantTypes", "id", "name", "redirectUris", "status", "useTachyonUserPool"]
