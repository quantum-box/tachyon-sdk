...
class ModelsResponse(BaseModel):
    ...
    total_count: StrictInt = Field(description="Total number of models returned.")
    __properties: ClassVar[List[str]] = ["models", "total_count"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "models": [ModelInfo.from_dict(_item) for _item in obj["models"]] if obj.get("models") is not None else None,
