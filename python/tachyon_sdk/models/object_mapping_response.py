...
class ObjectMappingResponse(BaseModel):
    ...
    provider_primary_id: StrictStr = Field(alias="providerPrimaryId")
    tenant_id: StrictStr = Field(alias="tenantId")
    updated_at: StrictStr = Field(alias="updatedAt")
    __properties: ClassVar[List[str]] = ["createdAt", "entityId", "objectName", "providerName", "providerPrimaryId", "tenantId", "updatedAt"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "providerPrimaryId": obj.get("providerPrimaryId"),
