...
class PurchaseOrderListResponse(BaseModel):
    ...
    """ # noqa: E501
    items: List[PurchaseOrderResponse] = Field(description="Purchase order items")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [PurchaseOrderResponse.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
