...
class AllowedTenantResponse(BaseModel):
    """
    Allowed tenant metadata. Denied tenants and policy internals are omitted.
    """ # noqa: E501
    alias: StrictStr
    execution_mode: StrictStr = Field(alias="executionMode")
    name: StrictStr
    parent_tenant_id: Optional[StrictStr] = Field(default=None, alias="parentTenantId")
    root_tenant_id: StrictStr = Field(alias="rootTenantId")
    tenant_id: StrictStr = Field(alias="tenantId")
    __properties: ClassVar[List[str]] = ["alias", "executionMode", "name", "parentTenantId", "rootTenantId", "tenantId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "rootTenantId": obj.get("rootTenantId"),
