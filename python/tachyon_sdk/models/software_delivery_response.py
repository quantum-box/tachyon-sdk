...
class SoftwareDeliveryResponse(BaseModel):
    """
    Response for software delivery
    """ # noqa: E501
    access_url: StrictStr = Field(alias="accessUrl")
    created_at: StrictStr = Field(alias="createdAt")
    delivered_at: StrictStr = Field(alias="deliveredAt")
    id: StrictStr
    order_id: StrictStr = Field(alias="orderId")
    status: StrictStr
    updated_at: StrictStr = Field(alias="updatedAt")
    __properties: ClassVar[List[str]] = ["accessUrl", "createdAt", "deliveredAt", "id", "orderId", "status", "updatedAt"]
