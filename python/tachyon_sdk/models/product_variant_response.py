...
class ProductVariantResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["code", "createdAt", "id", "metadata", "name", "productId", "status", "tenantId", "updatedAt"]
