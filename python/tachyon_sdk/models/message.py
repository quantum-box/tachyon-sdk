...
class Message(BaseModel):
    ...
    """ # noqa: E501
    content: Optional[MessageContent] = Field(default=None, description="The content of the message")
    role: StrictStr = Field(description="The role of the message author")
    tool_calls: Optional[List[ToolCallResponse]] = Field(default=None, description="The tool calls made by the assistant")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "role": obj.get("role"),
            "tool_calls": [ToolCallResponse.from_dict(_item) for _item in obj["tool_calls"]] if obj.get("tool_calls") is not None else None
        })
        return _obj
