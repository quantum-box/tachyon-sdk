...
class EvaluateActionsRequest(BaseModel):
    ...
    """ # noqa: E501
    actions: Optional[List[ActionEvaluationRequest]] = Field(default=None, description="List of actions to evaluate")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "actions": [ActionEvaluationRequest.from_dict(_item) for _item in obj["actions"]] if obj.get("actions") is not None else None
        })
        return _obj
