...
class UserPolicyMappingListResponse(BaseModel):
    """
    Response for user policy mappings list
    """ # noqa: E501
    mappings: List[UserPolicyMappingResponse]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "mappings": [UserPolicyMappingResponse.from_dict(_item) for _item in obj["mappings"]] if obj.get("mappings") is not None else None
        })
        return _obj
