...
class OAuth2UpdateClientRequest(BaseModel):
    """
    Request to update an OAuth2 client
    """ # noqa: E501
    allowed_scopes: Optional[List[StrictStr]] = Field(default=None, description="Allowed scopes", alias="allowedScopes")
    ...
    status: Optional[StrictStr] = Field(default=None, description="Status: \"active\" or \"inactive\"")
    __properties: ClassVar[List[str]] = ["allowedScopes", "name", "redirectUris", "status"]
