...
class UpdateChatroomRequest(BaseModel):
    ...
    name: Optional[StrictStr] = Field(default=None, description="Updated chatroom name")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "metadata": OneOf.from_dict(obj["metadata"]) if obj.get("metadata") is not None else None,
            "name": obj.get("name")
        })
        return _obj
