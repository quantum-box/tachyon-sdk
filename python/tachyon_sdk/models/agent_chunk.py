...
class AgentChunk(BaseModel):
    ...
    """ # noqa: E501
    is_client_tool: Optional[StrictBool] = Field(default=None, description="When `true`, this tool call targets a client-defined tool. The client should handle it locally and submit the result via the tool-result endpoint (unless `fire_and_forget`).")
    tool_id: StrictStr
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "is_client_tool": obj.get("is_client_tool"),
