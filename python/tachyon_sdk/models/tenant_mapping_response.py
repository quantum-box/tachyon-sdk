...
class TenantMappingResponse(BaseModel):
    ...
    provider_tenant_id: StrictStr = Field(alias="providerTenantId")
    tenant_id: StrictStr = Field(alias="tenantId")
    __properties: ClassVar[List[str]] = ["providerName", "providerTenantId", "tenantId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "providerTenantId": obj.get("providerTenantId"),
