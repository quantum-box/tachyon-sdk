...
class ChunkChoice(BaseModel):
    ...
    finish_reason: Optional[StrictStr] = Field(default=None, description="The finish reason")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "delta": DeltaMessage.from_dict(obj["delta"]) if obj.get("delta") is not None else None,
