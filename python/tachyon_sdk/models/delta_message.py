...
class DeltaMessage(BaseModel):
    ...
    role: Optional[ChatRole] = Field(default=None, description="The role of the message author")
    tool_calls: Optional[List[ToolCall]] = Field(default=None, description="The tool calls")
