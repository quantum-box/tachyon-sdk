...
class ConsentResponse(BaseModel):
    ...
    consented_at: StrictStr
    granted_scopes: List[StrictStr]
    revoked_at: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["client_id", "client_name", "consent_id", "consented_at", "granted_scopes", "revoked_at"]
