...
class OrderPurchaseOrdersApi:
    ...
    def get_purchase_order(
        self,
        id: Annotated[StrictStr, Field(description="Purchase order ID")],
    ...
    def _get_purchase_order_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/order/purchase-orders/{id}',
    ...
    def list_purchase_orders_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PurchaseOrderListResponse]:
        """List all purchase orders
    ...
    def _list_purchase_orders_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/order/purchase-orders',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
