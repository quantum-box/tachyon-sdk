...
class AuthUsersApi:
    ...
    def add_user_to_tenant(
        ...
        add_user_to_tenant_request: AddUserToTenantRequest,
        ...
        :type user_id: str
        :param add_user_to_tenant_request: (required)
        :type add_user_to_tenant_request: AddUserToTenantRequest
        ...
        _param = self._add_user_to_tenant_serialize(
            user_id=user_id,
            add_user_to_tenant_request=add_user_to_tenant_request,
    ...
    @validate_call
    def add_user_to_tenant_with_http_info(
        self,
        user_id: Annotated[StrictStr, Field(description="User ID")],
        add_user_to_tenant_request: AddUserToTenantRequest,
        _request_timeout: Union[
    ...
    @validate_call
    def add_user_to_tenant_without_preload_content(
        self,
        user_id: Annotated[StrictStr, Field(description="User ID")],
        add_user_to_tenant_request: AddUserToTenantRequest,
        _request_timeout: Union[
    ...
    def _add_user_to_tenant_serialize(
        self,
        user_id,
        add_user_to_tenant_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if add_user_to_tenant_request is not None:
            _body_params = add_user_to_tenant_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/auth/users/{user_id}/tenants',
    ...
    def _create_user_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/auth/v1beta/users',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def find_user_by_username(
        self,
        username: Annotated[StrictStr, Field(description="Username to search for")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param username: Username to search for (required)
        :type username: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
    ...
    def _find_user_by_username_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/auth/users/search/by-username',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _get_user_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/auth/users/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _invite_user_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/auth/users/invite',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def list_users(
        self,
        operator_id: Annotated[StrictStr, Field(description="Operator ID to list users for")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param operator_id: Operator ID to list users for (required)
    ...
    def _update_user_role_serialize(
        ...
        return self.api_client.param_serialize(
            method='PUT',
            resource_path='/v1/auth/users/{user_id}/role',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
