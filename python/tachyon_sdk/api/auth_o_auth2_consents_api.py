...
class AuthOAuth2ConsentsApi:
    ...
    def list_consents_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ConsentListResponse]:
        """GET /v1/auth/consents
    ...
    def _list_consents_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/auth/consents',
    ...
    def revoke_consent(
        self,
        id: Annotated[StrictStr, Field(description="Consent ID")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    def _revoke_consent_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/auth/consents/{id}/revoke',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
