...
class OrderCheckoutApi:
    ...
    def process_checkout(
        ...
        _param = self._process_checkout_serialize(
    ...
    @validate_call
    def process_checkout_with_http_info(
        self,
        checkout_request: CheckoutRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def process_checkout_without_preload_content(
        self,
        checkout_request: CheckoutRequest,
        _request_timeout: Union[
            None,
    ...
    def _process_checkout_serialize(
        self,
        checkout_request,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/order/checkout',
