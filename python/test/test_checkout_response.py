...
class TestCheckoutResponse(unittest.TestCase):
    """CheckoutResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CheckoutResponse:
